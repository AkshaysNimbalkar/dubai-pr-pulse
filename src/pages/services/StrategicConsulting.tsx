...
import { Brain, ArrowLeft, Compass, ChartBar, Users, Lightbulb } from 'lucide-react';
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-16">
              <div className="p-6 bg-gradient-to-r from-pink-600 to-matcha-600 rounded-3xl w-fit mx-auto mb-8">
